...
path = Path("data/phase3_gpu_scored.csv")
if not path.exists():
    path = Path("data/results/phase3_gpu_scored.csv")
if not path.exists():
    path = Path("phase3_gpu_scored.csv")
...
if df is None:
    ...
    clean_path = Path("data/results/phase3_gpu_scored_utf8.csv")
